...
<body>
			...
			<tbody>
				<tr>
					<c:forEach items="${commandList}" var="list">
						...
						<td><a href="delete?pid=${list.bookId}"><button type="button" class="btn btn-danger">DELETE</button></a></td>
						 <td><a href="showUpdate?pid=${list.bookId}"><button type="button" class="btn btn-success">UPDATE</button></a></td>
   ...
   <h1 style="color: red;text-align: center;">  ${id}</h1>
</body>
</html>